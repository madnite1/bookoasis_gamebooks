...
* **정밀 CRC32 분석**: MAME/FBNeo 및 주요 콘솔 기종의 27,000여 개 롬셋 정보를 내장한 초경량 SQLite DAT DB(`arcade_dat.db`)를 탑재하여 파일명이 영문 약칭이거나 `.7z` 압축이어도 정확한 한글 타이틀과 기종을 100% 감지합니다.
