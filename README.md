...
* **1,140+ 롬셋 전수 자동 진단**: 27,000여 개 DAT DB를 바탕으로 보유 중인 모든 아케이드/콘솔 롬의 내부 CRC32를 비교 분석하여 **100% 정상 구동 가능 게임**, **칩셋 누락 불완전 롬셋**, **CHD 디스크 필요 롬셋**을 실시간 분류 리포트로 제공합니다.
